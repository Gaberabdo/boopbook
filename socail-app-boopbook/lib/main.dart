...
const projectId = 'socail-app-99ae9';
const collectionPath = 'posts';

Future<List<dynamic>> fetchData() async {
  const url = '$baseUrl/projects/$projectId/databases/(default)/documents/$collectionPath';
  ...
  if (response.statusCode == 200 && data['documents'] != null) {
    ...
    return documents.map((doc) => doc['fields']).toList();
  } else {
